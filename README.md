  ...
  <main>
        ...
        <div class="carousel">
          ...
          <div class="carousel-rotation-direction">
            <ul class="carousel-item-wrapper" style="--_num-elements: 6">
              <li class="carousel-item" style="--_index: 1; --_image-url: url('01.jpeg')">
                <a href="#">Photo 1</a>
              </li>
              <li class="carousel-item" style="--_index: 2; --_image-url: url('02.jpeg')">
                <a href="#">Photo 2</a>
              </li>
              <li class="carousel-item" style="--_index: 3; --_image-url: url('03.jpeg')">
                <a href="#">Photo 3</a>
              </li>
              <li class="carousel-item" style="--_index: 4; --_image-url: url('04.jpeg')">
                <a href="#">Photo 4</a>
              </li>
              <li class="carousel-item" style="--_index: 5; --_image-url: url('05.jpeg')">
                <a href="#">Photo 5</a>
              </li>
              <li class="carousel-item" style="--_index: 6; --_image-url: url('01.jpeg')">
                <a href="#">Photo 6</a>
              </li>
    ...
    <section id="rsvp" class="section" data-aos="fade-up">
      <div class="container narrow">
        ...
        <form id="rsvp-form" class="rsvp-form" action="https://formspree.io/f/xdkrplvv" method="POST">
          <input type="text" name="Имя" id="guest_name" placeholder="Ваше имя*" required data-i18n-placeholder="guest_name_ph">
          <input type="email" name="Email" placeholder="Ваш email" data-i18n-placeholder="email_ph">
          <div class="attendance">
            <label><input type="radio" name="Присутствие" value="Да, приду" required data-i18n="attend_yes"> Да, приду</label>
            <label><input type="radio" name="Присутствие" value="Нет, не смогу" data-i18n="attend_no"> Нет, не смогу</label>
          </div>
          <input type="number" name="Количество гостей" id="guest_count" min="1" placeholder="Количество гостей" data-i18n-placeholder="guest_count_ph">
          <textarea name="Пожелания и комментарии" id="rsvp_comment" placeholder="Особые пожелания (диета, аллергии и т.д.)" data-i18n-placeholder="rsvp_comment_ph"></textarea>
          <button type="submit" class="btn" data-i18n="submit_rsvp">Подтвердить</button>
        </form>
    ...
    <section id="location" class="section" data-aos="fade-up">
      <div class="container">
        ...
        <div class="map-container">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3028.5782754908223!2d72.12597298950288!3d40.267671832011295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38bc739edceea053%3A0x727a605c6b47c68c!2z0KfQtdC80L_QuNC-0L0g0JDRgNC10L3QsA!5e0!3m2!1sru!2skg!4v1764337271673!5m2!1sru!2skg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <p class="map-address" data-i18n="map_address">📍 Ресторан "Чемпион Арена", г. Кызыл-Кия, Кыргызстан</p>
      </div>
    </section>
  </main>
  <footer class="site-footer">
    <div class="container">
      <div class="footer-inner">
        <p data-i18n="footer">© Мээримгул & Максат — Декабрь 2025</p>
